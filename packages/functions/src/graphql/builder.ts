...
builder.queryType({ description: 'UpFrom app queries' }); // Additional queries should be added with queryFields
builder.mutationType({ description: 'UpFrom app mutations' }); // Additional mutations should be added with mutationFields
