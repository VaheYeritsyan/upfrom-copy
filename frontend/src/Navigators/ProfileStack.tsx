...
import { ProfileStackParamList, Screens, Stacks, TabStackParamList } from '~types/navigation';
...
type Props = BottomTabScreenProps<TabStackParamList, Stacks.PROFILE>;

const Stack = createStackNavigator<ProfileStackParamList>();
export const ProfileStack: FC<Props> = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    <Stack.Screen name={Screens.OWN_PROFILE} component={UserProfile} />
