...
import { HomeStackParamList, Screens, Stacks, TabStackParamList } from '~types/navigation';
...
type Props = BottomTabScreenProps<TabStackParamList, Stacks.HOME>;
...
export const HomeStack: FC<Props> = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name={Screens.TEAMS} component={Teams} />
