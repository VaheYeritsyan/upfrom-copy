...
export const IndividualEvent: FC<Props> = ({
  style,
  attendee,
  team,
  teams,
  ...
  <View style={style}>
    <View style={styles.section}>
      <Typography variant="body1SemiBold">You are creating an Individual Event with the mentee.</Typography>
